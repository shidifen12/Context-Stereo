...
parser = argparse.ArgumentParser(description='Context_Stereo')
parser.add_argument('--model', default='Stereo', help='select a model structure', choices=__models__.keys())
parser.add_argument('--maxdisp', type=int, default=192, help='maximum disparity')
parser.add_argument('--dataset', default='kitti', help='dataset name', choices=__datasets__.keys())
parser.add_argument('--datapath_12', default="/home/admin1/zj/data_scene_flow/kitti_2012/", help='data path')
parser.add_argument('--datapath_15', default="/home/admin1/zj/data_scene_flow/kitti_2015/", help='data path')
parser.add_argument('--testlist',default='./filenames/kitti15_test.txt', help='testing list')
parser.add_argument('--loadckpt', default='kitti_results/t149/best_result3_4_e.tar',help='load the weights from a specific checkpoint')
# parse arguments
