...
parser = argparse.ArgumentParser(description='Context-Stereo')
parser.add_argument('--model', default='Stereo', help='select a model structure', choices=__models__.keys())
parser.add_argument('--maxdisp', type=int, default=192, help='maximum disparity')
parser.add_argument('--datapath', default="/home/admin1/djw/test/cgi/middlebury", help='data path')
parser.add_argument('--resolution', type=str, default='H')
parser.add_argument('--loadckpt', default='results/t1/checkpoint_33.tar',help='load the weights from a specific checkpoint')
