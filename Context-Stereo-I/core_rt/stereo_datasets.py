...
class SceneFlowDatasets(StereoDataset):
    def __init__(self, aug_params=None, root='/media/ano/HOME/customer/Datasets/sceneflow/', dstype='frames_finalpass', things_test=False):
...
class ETH3D(StereoDataset):
    def __init__(self, aug_params=None, root='/media/ano/HOME/customer/Datasets/eth3d', split='training'):
...
class SintelStereo(StereoDataset):
    def __init__(self, aug_params=None, root='/media/wei/a083b055-d6e8-44c6-bcfd-41b7c2b210bc/wei/StereoDatasets/sintelstereo'):
...
class FallingThings(StereoDataset):
    def __init__(self, aug_params=None, root='/media/wei/a083b055-d6e8-44c6-bcfd-41b7c2b210bc/wei/StereoDatasets/fallingthings'):
...
class TartanAir(StereoDataset):
    def __init__(self, aug_params=None, root='/media/wei/a083b055-d6e8-44c6-bcfd-41b7c2b210bc/wei/StereoDatasets/tartanair'):
...
class CREStereoDataset(StereoDataset):
    def __init__(self, aug_params=None, root='/media/wei/a083b055-d6e8-44c6-bcfd-41b7c2b210bc/wei/StereoDatasets/crestereo'):
...
class CARLA(StereoDataset):
    def __init__(self, aug_params=None, root='/media/wei/a083b055-d6e8-44c6-bcfd-41b7c2b210bc/wei/StereoDatasets/carla-highres'):
...
class InStereo2K(StereoDataset):
    def __init__(self, aug_params=None, root='/media/wei/a083b055-d6e8-44c6-bcfd-41b7c2b210bc/wei/StereoDatasets/instereo2k'):
...
class KITTI(StereoDataset):
    def __init__(self, aug_params=None, root='/media/ano/HOME/customer/Datasets/kitti', image_set='training', year=2012):
        super(KITTI, self).__init__(aug_params, sparse=True, reader=frame_utils.readDispKITTI)
        assert os.path.exists(root)

        if year == 2012:
            root_12 = '/media/ano/HOME/customer/Datasets/kitti/2012'
        ...
        if year == 2015:
            root_15 = '/media/ano/HOME/customer/Datasets/kitti/2015'
...
class VKITTI2(StereoDataset):
    def __init__(self, aug_params=None, root='/media/wei/a083b055-d6e8-44c6-bcfd-41b7c2b210bc/wei/StereoDatasets/vkitti2'):
...
class Middlebury(StereoDataset):
    def __init__(self, aug_params=None, root='/media/ano/HOME/customer/Datasets/igev/middlebury', split='2014', resolution='F'):
        ...
        if split == "2005":
            ...
            disp_list = sorted(glob(os.path.join(root, "MiddEval3", f'training-gt-{resolution}', '*/disp0GT.pfm')))
