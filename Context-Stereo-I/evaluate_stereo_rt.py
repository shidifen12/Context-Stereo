...
@torch.no_grad()
def validate_middlebury(model, iters=8, split='MiddEval3', resolution='F', mixed_prec=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore_ckpt', help="restore checkpoint", default='./checkpoints_rt/200000_rt-igev-stereo.pth')
    # parser.add_argument('--restore_ckpt', help="restore checkpoint", default='../IGEV-plusplus-2/best-1.72/rt_sceneflow_cp_last_0.44/200000_rt-igev-stereo.pth')
