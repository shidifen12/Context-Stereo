...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore_ckpt', default="./checkpoints_rt/200000_rt-igev-stereo.pth", help='load the weights from a specific checkpoint')
    parser.add_argument('--logdir', default='./checkpoints_rt_kt', help='the directory to save logs and checkpoints')
    parser.add_argument('--mixed_precision', default=True, action='store_true', help='use mixed precision')

    # Training parameters
    parser.add_argument('--batch_size', type=int, default=8, help="batch size used during training.")
    parser.add_argument('--train_datasets', default='kitti', choices=['sceneflow', 'kitti'], help="training datasets.")
    ...
    parser.add_argument('--valid_iters', type=int, default=4, help='number of flow-field updates during validation forward pass')
