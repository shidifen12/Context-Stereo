...
parser.add_argument('--datapath', default="/home/admin1/zj/data_scene_flow/kitti_2012/training/", help='data path')
parser.add_argument('--kitti', type=str, default='2012')
parser.add_argument('--loadckpt', default='results/AGS/checkpoint_30.tar',
