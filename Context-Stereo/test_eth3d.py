...
parser.add_argument('--datapath', default='/home/admin1/djw/test/eth3d/', help='data path')
parser.add_argument('--loadckpt', default='results/AGS/checkpoint_30.tar',help='load the weights from a specific checkpoint')
